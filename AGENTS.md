...
> **Keep the docs in sync.** On every feature change (add / remove / behavior change), update **both** `spec.md` (the authoritative feature behavior) **and** this `AGENTS.md` (architecture/conventions) in the same change. Do not let code drift ahead of the docs.
...
This project is catalogued in my personal Obsidian Vault (`/mnt/x/Obsidian/Obsidian Vault/`): note `Projets/GeminisWatchinU.md`.
